...
object phMaxCalcActionForServier {
    def apply(args: pActionArgs = NULLArgs): pActionTrait = new phMaxCalcActionForServier(args)
}

class phMaxCalcActionForServier(override val defaultArgs: pActionArgs) extends pActionTrait {
